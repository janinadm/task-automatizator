...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const members = computed(() => {
      var _a, _b;
      return (_b = (_a = teamData.value) == null ? void 0 : _a.data.team) != null ? _b : [];
    });
    const isAdmin = computed(() => {
      var _a;
      return ((_a = teamData.value) == null ? void 0 : _a.data.currentUserRole) === "ADMIN";
    });
    ...
    const invitations = computed(() => {
      var _a, _b;
      return (_b = (_a = invitationsData.value) == null ? void 0 : _a.data) != null ? _b : [];
    });
    ...
    async function toggleRole(member) {
      ...
      try {
        ...
        toast.error((_b = (_a = e == null ? void 0 : e.data) == null ? void 0 : _a.message) != null ? _b : "Failed to update role");
      } finally {
    ...
    async function toggleActive(member) {
      ...
      try {
        ...
        toast.error((_b = (_a = e == null ? void 0 : e.data) == null ? void 0 : _a.message) != null ? _b : "Failed to update status");
      } finally {
        updatingId.value = null;
      }
    }
              ...
              if (_push2) {
                ...
                return [
                  createVNode("div", { class: "flex items-center gap-4 flex-wrap sm:flex-nowrap" }, [
                    ...
                    }, toDisplayString((_f = (_e = (_d = member.fullName) == null ? void 0 : _d.charAt(0)) == null ? void 0 : _e.toUpperCase()) != null ? _f : "?"), 3),
