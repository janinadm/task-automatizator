          ...
          if (_push2) {
            ...
            if (unref(ticketsStore).isLoadingList) {
              ...
              ssrRenderList(unref(ticketsStore).tickets, (ticket) => {
                ...
                _push2(ssrRenderComponent(_component_NuxtLink, {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      ...
                      if ((ticket._count?.messages ?? 0) > 0) {
                        _push3(`<span class="ml-2" data-v-b5a88f46${_scopeId2}> · ${ssrInterpolate(ticket._count?.messages)} msg${ssrInterpolate((ticket._count?.messages ?? 0) === 1 ? "" : "s")}</span>`);
                      } else {
                        _push3(`<!---->`);
                      }
                      _push3(`</p>`);
                      ...
                      return [
                        ...
                        createVNode("p", { class: "text-white/40 text-xs mt-0.5 truncate" }, [
                          ...
                          (ticket._count?.messages ?? 0) > 0 ? (openBlock(), createBlock("span", {
                            key: 0,
                            class: "ml-2"
                          }, " · " + toDisplayString(ticket._count?.messages) + " msg" + toDisplayString((ticket._count?.messages ?? 0) === 1 ? "" : "s"), 1)) : createCommentVNode("", true)
                        ])
                      ];
                    }
                  }),
                ...
                _push2(`<span class="${ssrRenderClass([statusConfig[ticket.status]?.class, "hidden md:inline-flex px-2 py-0.5 rounded-full text-xs font-medium whitespace-nowrap"])}" data-v-b5a88f46${_scopeId}>${ssrInterpolate(statusConfig[ticket.status]?.label)}</span><div class="hidden md:flex items-center gap-1.5" data-v-b5a88f46${_scopeId}><div class="${ssrRenderClass([priorityConfig[ticket.priority]?.dot, "w-2 h-2 rounded-full"])}" data-v-b5a88f46${_scopeId}></div><span class="${ssrRenderClass([priorityConfig[ticket.priority]?.text, "text-xs"])}" data-v-b5a88f46${_scopeId}>${ssrInterpolate(priorityConfig[ticket.priority]?.label)}</span></div><div class="hidden lg:flex items-center justify-center w-7 h-7" data-v-b5a88f46${_scopeId}>`);
            ...
            return [
              ...
              unref(ticketsStore).isLoadingList ? (openBlock(), createBlock("div", {
                ...
                (openBlock(true), createBlock(Fragment, null, renderList(unref(ticketsStore).tickets, (ticket) => {
                  return openBlock(), createBlock("div", {
                    ...
                    createVNode("span", {
                      class: ["hidden md:inline-flex px-2 py-0.5 rounded-full text-xs font-medium whitespace-nowrap", statusConfig[ticket.status]?.class]
                    }, toDisplayString(statusConfig[ticket.status]?.label), 3),
                    createVNode("div", { class: "hidden md:flex items-center gap-1.5" }, [
                      createVNode("div", {
                        class: ["w-2 h-2 rounded-full", priorityConfig[ticket.priority]?.dot]
                      }, null, 2),
                      createVNode("span", {
                        class: ["text-xs", priorityConfig[ticket.priority]?.text]
                      }, toDisplayString(priorityConfig[ticket.priority]?.label), 3)
                    ]),
              ...
              (unref(ticketsStore).meta?.totalPages ?? 0) > 1 ? (openBlock(), createBlock("div", {
                key: 4,
                class: "flex items-center justify-between px-5 py-3 border-t border-white/10"
              }, [
                createVNode("p", { class: "text-white/40 text-xs" }, " Page " + toDisplayString(unref(ticketsStore).currentPage) + " of " + toDisplayString(unref(ticketsStore).totalPages) + " · " + toDisplayString(unref(ticketsStore).meta?.total) + " tickets ", 1),
