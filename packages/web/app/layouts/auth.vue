<!--
  ...
  Split-screen design:
  - Left: Visual branding panel with floating glass elements and ambient glow
  - Right: Auth form content (login/signup/confirm)
  On mobile: stacks vertically with a compact header.
-->
<template>
  <div class="min-h-screen flex bg-[#06050f] overflow-hidden">
    <!-- ═══════════════════════════════════════════════════════════
        ...
        <div class="relative h-64 w-full">
          ...
          <div class="absolute left-0 top-0 w-52 p-4 bg-white/[0.05] backdrop-blur-xl border border-white/[0.08] rounded-2xl shadow-xl animate-fade-in" style="animation-delay: 0.3s">
            <div class="flex items-center gap-3 mb-3">
              ...
              <div>
                <p class="text-white/40 text-[10px]">Response Time</p>
                <p class="text-emerald-400 text-sm font-bold">-60%</p>
              </div>
            </div>
    ...
    <div class="flex-1 flex flex-col items-center justify-center p-4 sm:p-8 relative">
      ...
      <div class="mt-8 text-center">
        <NuxtLink to="/" class="text-white/25 hover:text-white/50 text-xs transition-colors">
