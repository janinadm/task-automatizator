  ...
  <div>
    ...
    <div class="mb-8">
      ...
      <p class="text-white/50 text-sm mt-2">
        Sign in to your AI-powered support dashboard
      </p>
    </div>
    ...
    <form class="space-y-5" @submit.prevent="handleLogin">
      ...
      <div>
        <div class="flex items-center justify-between mb-2">
          ...
          <NuxtLink to="/reset-password" class="text-xs text-indigo-400 hover:text-indigo-300 transition-colors">
            Forgot password?
          </NuxtLink>
        </div>
        <div class="relative">
    ...
    <p class="text-center text-white/40 text-sm mt-8">
      ...
      <NuxtLink to="/signup" class="text-indigo-400 hover:text-indigo-300 font-semibold transition-colors ml-1">
        Create one for free
      </NuxtLink>
    </p>
  </div>
